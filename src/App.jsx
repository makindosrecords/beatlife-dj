              ...
              <div className="relative z-10">
                 ...
                 <div className="space-y-8">
                    <div className="flex gap-6 items-center group cursor-pointer">
                      ...
                      <div><p className="text-[10px] font-black uppercase opacity-60 tracking-widest mb-1 italic">The Hotline</p><p className="text-2xl font-black italic tracking-tighter leading-none">(321) 400-3507</p></div>
                    </div>
